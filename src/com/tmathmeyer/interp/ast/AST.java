...
public interface AST
{
	...
	ImmutableList<ASTBinding> structureCompare(AST t);
	ImmutableList<ASTBinding> structureCompare(ASTree t);
	ImmutableList<ASTBinding> structureCompare(ASNode t);
	ImmutableList<ASTBinding> structureCompare(RepeatingAST t);
